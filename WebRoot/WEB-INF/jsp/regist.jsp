...
<script >
  ...
  //校验用户名：
   ...
   function change(){
       ...
       checkImg.src="${pageContext.request.contextPath}/checkImg?time="+new Date().getTime();
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath }/user_registe.action" method="post" novalidate="novalidate" onsubmit="return checkForm()">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<td>
									<input id ="repassword" type="password" name="password" class="text" maxlength="20" autocomplete="off">
								</td>
							</tr>
							<tr>
								<th>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off"><img  class="captchaImage" src="${pageContext.request.contextPath}/checkImg.action" onclick="change()" id="checkImg" title="点击更换验证码">
										</span>
									</td>
